...
if ($_FILES["resim"]["size"]<1024*1024){//Dosya boyutu 1Mb tan az olsun
	...
	if($_FILES["resim"]["name"]<>""){
		$guncelle1=mysql_query("update kullanici set KullaniciAd='$kuladi',Ad='$ad',Soyad='$soyad',Resim='$yeni_ad',Eposta='$eposta',Sifre='$sifre',Dtarih='$dtarih',Dyeri='$dyeri',GizliSoru='$gsoru',GizliCevap='$gcevap',OgrenimDurumu='$egitim',Meslek='$meslek',Adres='$adres',il='$il',ilce='$ilce',Gsm='$gsm',Cinsiyet='$cinsiyet' where idKullanici='$sid1'");}	
	else{
		$guncelle2=mysql_query("update kullanici set KullaniciAd='$kuladi',Ad='$ad',Soyad='$soyad',Eposta='$eposta',Sifre='$sifre',Dtarih='$dtarih',Dyeri='$dyeri',GizliSoru='$gsoru',GizliCevap='$gcevap',OgrenimDurumu='$egitim',Meslek='$meslek',Adres='$adres',il='$il',ilce='$ilce',Gsm='$gsm',Cinsiyet='$cinsiyet' where idKullanici='$sid1'");
	}	
	
		
}
// where den sonra yazılan yere   kullanicinin hangi bilgisi geliyorsa sayfaya ona göre yapılıcak


	   if(($guncelle1 or $guncelle2) and ($sifre==$sifretekrar) ){
...
$sec=mysql_query("Select * from kullanici where idKullanici='$sid1'");
