...
while($arama1=mysql_fetch_array($arama) or die("<br> $numara. Yazarın Kitabı <hr> Aradığınız yazar bulunamadı.. Arama motorumuz  büyük küçük harf'e duyarlıdır.".mysql_error())){
	
	echo " $numara. Yazarın Kitabı <hr>
